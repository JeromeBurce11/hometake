...
<h2 class="ml-5 mt-5 card-title" style="color:#3751FE">Video Music Collection</h2>
    ...
    <div class="mt-2 mr-5 ml-5 card" style="">
        <div class="card-body">
            ...
            <p class="card-text p-3">When you order a video tour from us, you'll be able to choose from two editing
                ...
                specifically to the beat of this music track (below). Modern Style video scenes are 'sped up' in certain
                areas of a scene/shot. This creates a 'fast forward' visual effect and also helps us edit the video to
                the beat of the music.
            </p>
            <p class="card-text p-3">
                As Modern Style is our most popular video edit choice among our clients, it's the defaulted style for
                your order. If you don't like this style, please makes sure that you select the Classic Style as there
                is a $25 re-edit fee if you want to change the style after the video has been edited. If you change your
                edit selection to Classic Style, the Modern video sample disappears and music choices will appear. Then
                you will be able to select your music choice from multiple music tracks to go with your Classic Style
                video.
            </p>
            <div class="text-center">
                ...
                <h4 class=" mt-1 card-title text-center" style="color:#3751FE">You can select your music track for the
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-3">
                                <select name="classicalMusic" class="custom-select" id="classicalMusic">
                                    ...
                                    <option value="Classical01_BlueDanubebyStrauss">1 Blue Danube by Strauss</option>
                                    <option value="Classical02_EineKleineNachtmusikbyMozart">2 Eine Kleine Nachtmusik by
                                        Mozart</option>
                                    <option value="Classical03_WaltzoftheFlowersbyTchaikovsky">3 Waltz of the Flowers by
                                        Tchaikovsky</option>
                                    ...
                                    <option value="Classical11_HungarianRhapsodyNo2byLiszt">11 Hungarian Rhapsody No 2
                                        by
                                        Liszt</option>
                                    <option value="Classical12_RideoftheValkyriesbyWagner">12 Ride of the Valkyries by
                                        Wagner</option>
                                    <option value="Classical13_SymphonyNo5byBeethoven">13 Symphony No 5 by Beethoven
                                    </option>
                                    <option value="Classical14_FurElisebyBeethoven">14 Fur Elise by Beethoven</option>
                                    <option value="Classical15_WilliamTellOverturebyRossini">15 William Tell Overture by
                                        Rossini</option>
                                </select>
                            </div>
                            <audio id="audio" controls="controls">
